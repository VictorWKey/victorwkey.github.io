...
function spanish() {
  return [
    ...
    blt("Dise\u00f1\u00f3 y despleg\u00f3 un agente de IA conversacional que interact\u00faa con todos los servicios clave de la plataforma, permitiendo a los usuarios operarla en lenguaje natural; construido con arquitectura din\u00e1mica y extensible que integra autom\u00e1ticamente los nuevos servicios conforme la plataforma crece."),
    blt("Impuls\u00f3 el dise\u00f1o t\u00e9cnico de 8 servicios de la plataforma que implement\u00f3; restructur\u00f3 la arquitectura del proyecto para mayor escalabilidad y mejor experiencia de desarrollo, y comunic\u00f3 decisiones de dise\u00f1o de sistemas IA al liderazgo no t\u00e9cnico para alinear la estrategia de la plataforma."),
    blt("Construy\u00f3 9 workflows LLM en diversos servicios de la plataforma para automatizar la extracci\u00f3n de informaci\u00f3n valiosa de m\u00faltiples fuentes, garantizando salidas estructuradas y consistentes para su visualizaci\u00f3n y an\u00e1lisis posteriores."),
    blt("Construy\u00f3 m\u00f3dulos de an\u00e1lisis y evaluaci\u00f3n desde cero con estrategias de optimizaci\u00f3n de inferencia, logrando una reducci\u00f3n del 40-60% en consumo de tokens y costos de c\u00f3mputo junto con una mejora del 40% en el rendimiento general del sistema."),
